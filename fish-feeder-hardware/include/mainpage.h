...
$('#feed-card').click(() => {
    ...
    $('.loading').removeClass('d-none')
    $('.loading .message').text(`Đang cho ăn ${$('#amount').val()}g`)
    setTimeout(() => {
